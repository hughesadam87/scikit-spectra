...
scikit-spectra took this code from from scikit-images' adaptation of
scikit-learn's version. We thank scikit-image and scikit-learn for making 
these utilities open and for extending the capabilities for documentation
in python.
